...
<title>restful Test</title>  
    ...
    <link rel="stylesheet" type="text/css"   href="resources/plugs/uikit-2.25.0/css/uikit.gradient.min.css">
    <link rel="stylesheet" type="text/css" href="resources/plugs/uikit-2.25.0/css/components/notify.gradient.min.css">  
</head>  
<body>  
<div  
...
<script type="text/javascript" src="resources/plugs/uikit-2.25.0/js/uikit.min.js"></script>  
<script type="text/javascript" src="resources/plugs/uikit-2.25.0/js/components/notify.min.js"></script>  
<script type="text/javascript">  
    (function(window,$){  
        ...
        var dekota={  
            ...
            getPerson:function(){  
            	/* $.ajax({  
                    url: dekota.url + 'wireless-gateway/v1.0/getSmsCode',  
                    type: 'GET',  
                    dataType: 'json',
                    data:{
                    	"version":"1.0.0",
                    	"interfaceId":"getSmsCode",
                    	"timeStamp":"20161128100145",
                    	"digest":"OTcyNDllYmM5NWZhZTRkNzc3ZjQ3NDA3ZWY3YWUwYWU=",
                    	"data":'{"msisdn":"15175667809"}'}
            ...
            addPerson:function(){  
            	$.ajax({  
                    ...
                    data:{
                    	"version":"1.0.0",
                    	"interfaceId":"login",
                    	"timeStamp":"20161202163000",
                    	"digest":"OTcyNDllYmM5NWZhZTRkNzc3ZjQ3NDA3ZWY3YWUwYWU=",
                    	"data":'{"msisdn":"15175667809","smsCode":"","osType":"Android","osVersion":"1.0.0","deviceType":"mate9pro","resolution":"1080*1920","IMEI":"imei"}'}  
                }).done(function(data, status, xhr) {  
